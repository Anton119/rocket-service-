module github.com/Anton119/rocket-service-/assembly
...
replace (
	github.com/Anton119/rocket-service-/platform => ../platform
	github.com/Anton119/rocket-service-/shared => ../shared
)
