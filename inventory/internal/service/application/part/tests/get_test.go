...
import (
	...
	"github.com/Anton119/rocket-service-/inventory/internal/service/application/part"
	"github.com/Anton119/rocket-service-/inventory/internal/service/application/part/mocks"
...
func TestGetPart(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			svc := part.NewService(repo, passthroughTx{}, domain.NewCompatibilityChecker())
			got, err := svc.GetPart(ctx, partUUID)
