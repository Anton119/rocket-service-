...
func (_mock *OrderRepository) GetForUpdate(ctx context.Context, id uuid.UUID) (model.Order, error) {
	ret := _mock.Called(ctx, id)
...
func (_c *OrderRepository_GetForUpdate_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID) (model.Order, error)) *OrderRepository_GetForUpdate_Call {
	_c.Call.Return(run)
	return _c
}
