module github.com/Anton119/rocket-service-/order
...
replace github.com/Anton119/rocket-service-/inventory => ./../inventory

replace github.com/Anton119/rocket-service-/payment => ./../payment
